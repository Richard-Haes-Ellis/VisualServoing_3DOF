...
min_delay = 1570;               % Minimum delay for a given speed
step_delay = 847239;            % First C0 delay time
steps_2_max_speed = 10000;       % steps_2_max_speed = speed^2 / (2*alpha*accel)
